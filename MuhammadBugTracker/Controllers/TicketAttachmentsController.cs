...
namespace MuhammadBugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,FilePath,Description")] TicketAttachment ticketAttachment, HttpPostedFileBase file)
        {
            if (ModelState.IsValid)
            {
                if (FileUploadValidator.IsWebFriendlyImage(file))
                {
                    ...
                    ticketAttachment.FilePath = "/Files/Uploads/" + fileName;
                }
